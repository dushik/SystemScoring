...
namespace opencvDemo
{
    ...
    {
        public static void funzhifang()
        {
            using (var src = new Mat(@"D:\img\scoring\shijuan.bmp", ImreadModes.AnyDepth | ImreadModes.AnyColor))
            {
        ...
        public static void updateImageCalculateHistogram(Window sourceWindow, Window histogramWindow, Mat src, int brightness, int contrast)
        {
            using (var modifiedSrc = new Mat())
            {
        ...
        public static void calculateHistogram1(Window histogramWindow, Mat src, Mat modifiedSrc)
        {
            const int histogramSize = 64;//from 0 to 63
            int[] dimensions = { histogramSize }; // Histogram size for each dimension
            Rangef[] ranges = { new Rangef(0, histogramSize) }; // min/max
        ...
        public static void calculateHistogram2(Window histogramWindow, Mat src, Mat modifiedSrc)
        {
            const int histogramSize = 64;//from 0 to 63
            using (var histogram = new Mat())
            {
