...
namespace SYStem.myForm
{
    ...
    public partial class frmMessageBox : Form
    {
        public frmMessageBox(MessageBoxStyle messageBoxStyle,string msg)
        {
            ...
            {
                picICO.Image = global::SyStem.Properties.Resources.info;
                this.Text = "提示";
                panel1.Visible = true;
            ...
            {
                picICO.Image = global::SyStem.Properties.Resources.question;
                this.Text = "询问";
            ...
            {
                picICO.Image = global::SyStem.Properties.Resources.error;
                this.Text = "错误";
                panel1.Visible = true;
                panel2.Visible = false;
            }
